...
r_range     = c(0.05, 0.05) # Set to c(0.05, 0.05) if not modelling (0.01, 0.12)
sigma_range = c(0.2, 0.2) # Set to c(0.2, 0.2) if not modelling (0.05, 0.5)
...
training_cols           = c("S_K", "T_t") # Vector of columns to be used in training the model(s) (set up for "S_K", "T_t", "b", "eta", "r", "sigma", "dummy")
